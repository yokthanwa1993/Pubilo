            ...
            document.addEventListener('click', (e) => {
                ...
                console.log('[DEBUG CLICK]', tagName, 'id:', id, 'class:', className);
                // Check if it's the regenNewBtn or inside it
                if (target.closest('#regenNewBtn')) {
                    console.log('[DEBUG CLICK] Clicked inside #regenNewBtn!');
                }
            }, true);
            ...
            const scheduleMinutesGrid =
                document.getElementById("scheduleMinutesGrid");
            ...
            function buildPublishedTable(logs) {
                ...
                const thead = document.createElement("thead");
                const headerRow = document.createElement("tr");
                ["Type", "Message", "Time", "Status", "Link", "Delete"].forEach((text) => {
                    const th = document.createElement("th");
                    th.textContent = text;
                    headerRow.appendChild(th);
                });
            ...
            let quotesFilter = 'unused'; // 'unused' or 'used'
            ...
            async function regenerateImages(getNewText = false) {
                ...
                console.log('[DEBUG regenerateImages] mode:', mode, 'isLinkMode:', isLinkMode, 'getNewText:', getNewText);
                console.log('[DEBUG regenerateImages] state.generatedImages:', state.generatedImages);
                console.log('[DEBUG regenerateImages] hasGeneratedImages:', hasGeneratedImages);
                console.log('[DEBUG regenerateImages] state.lastCaption:', state.lastCaption);
                console.log('[DEBUG regenerateImages] caption field:', captionCheck?.value);
            ...
            function setupPublishHandler(mode) {
                ...
                els.publishBtn.addEventListener("click", async () => {
                    console.log('[PUBLISH] Button clicked! Mode:', mode, 'Stack trace:', new Error().stack);
                    const state = modeState[mode];
